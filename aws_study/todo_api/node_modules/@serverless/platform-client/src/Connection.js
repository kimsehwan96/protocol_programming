...
class Connection {
  ...
  async connect(options) {
    ...
    if (this.sdk.context.orgName) {
      queryParams = queryParams + `orgName=${this.sdk.context.orgName}&`
    }
    if (this.sdk.context.orgUid) {
      queryParams = queryParams + `orgUid=${this.sdk.context.orgUid}&`
    }
    ...
    return new Promise((resolve, reject) => {
      ...
      self.connection.onerror = (error) => {
        return reject(new Error(`Unexpected Serverless Platform Streaming Error: ${error.message}`))
      }
