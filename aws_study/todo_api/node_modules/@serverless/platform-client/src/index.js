...
class ServerlessSDK {
  ...
  async login(config = {}) {
    ...
    loginUrl =
      config.componentName && config.componentVersion
        ? `${loginUrl}/${config.componentVersion}`
        : loginUrl
  ...
  async validateUserAndOrgName(userAndOrgName) {
    return await resources.validateUserAndOrgName(this, userAndOrgName)
  }
  ...
  async createUserAndOrg(userAndOrgName) {
    return await resources.createUserAndOrg(this, userAndOrgName)
  }
  ...
  async createOrg(userAndOrgName) {
    return await resources.createOrg(this, userAndOrgName)
  }
  ...
  async getOrgByName(orgName) {
    return await resources.getOrgByName(this, orgName)
  }
  ...
  async listOrgs(username) {
    return await resources.listOrgs(this, username)
  }
  ...
  async createApp(orgName = null, app = {}) {
    return await resources.createApp(this, orgName, app)
  }
  ...
  async updateApp(orgName = null, app = {}) {
    return await resources.updateApp(this, orgName, app)
  }
  ...
  async deleteApp(orgName = null, appName = null) {
    return await resources.updateApp(this, orgName, appName)
  }
  ...
  async listApps(orgName = null) {
    return await resources.listApps(this, orgName)
  }
  ...
  async createInitToken(orgName = null, template = {}) {
    return await resources.createInitToken(this, orgName, template)
  }
   ...
   */
  async getInitToken(initTokenUid = null) {
    return await resources.getInitToken(this, initTokenUid)
  }
  ...
  async publishToRegistry(registryPackage = {}) {
    return await registry.publish(this, registryPackage)
  }
  ...
  async getFromRegistry(name = null, version = null) {
    return await registry.get(this, name, version)
  }
  ...
  async stopInterceptingLogs() {
    ...
    // Replace console methods
    console.log = this.intercepts.console.log // eslint-disable-line
    console.debug = this.intercepts.console.debug // eslint-disable-line
    console.error = this.intercepts.console.error // eslint-disable-line
    console.warn = this.intercepts.console.warn // eslint-disable-line
